      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-purple-700 text-white py-26">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Explore our premium collection of latest vehicles with unbeatable prices and exceptional service
          </p>
          ...
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-16 h-16 border-4 border-purple-600 border-b-transparent rounded-full animate-spin mx-auto mb-4" style={{ animationDirection: 'reverse' }}></div>
              </div>
              <p className="text-gray-600 text-lg font-semibold">Loading amazing cars...</p>
            </div>
          </div>
        )}
        ...
        {!loading && cars.length === 0 && (
          <div className="text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-3">No cars found</h3>
